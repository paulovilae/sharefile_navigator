...
import SharePointNavigatorContent from './SharePointNavigatorContent';
...
const SharePointNavigatorContentWrapper = ({
  config,
  onSelectionChange,
  onExecutionUpdate,
  multiSelect,
  ...
  return (
    <SharePointNavigatorContent
      libraries={libraries}
      // setLibraries is not directly needed by SharePointNavigatorContent if API hook handles it
      ...
      items={items}
      // setItems is not directly needed by SharePointNavigatorContent if API/Handler hooks handle it
      loading={loading}
      // setLoading is not directly needed by SharePointNavigatorContent if API/Handler hooks handle it
      error={error}
      // setError is not directly needed by SharePointNavigatorContent if API/Handler hooks handle it
...
export default SharePointNavigatorContentWrapper;