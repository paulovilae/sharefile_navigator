...
const SharePointNavigatorMetrics = ({ metrics, metricsExpanded, setMetricsExpanded, getSessionDuration }) => {
  const theme = useTheme();
  console.log('SharePointNavigatorMetrics theme:', theme);
  return (
    <Box>
...
export default SharePointNavigatorMetrics;